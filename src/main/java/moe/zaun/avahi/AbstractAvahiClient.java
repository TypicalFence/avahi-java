...
public abstract class AbstractAvahiClient implements freeable, AvahiClientCallback {

    protected final AvahiClientPointer pointer;
    protected final IntByReference error;

    public AbstractAvahiClient(AvahiPoll poll) {
    ...
    protected abstract void callBack(AbstractAvahiClient client, int state);
